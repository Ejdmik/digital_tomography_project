...
Chapter 1 brings an overview of different types of encodings used to transform high-level constraints into conjunctive normal form (CNF), since SAT solvers operate exclusively on CNF formulas. We therefore present several commonly used encoding techniques, discuss their principles, and emphasize their strengths and weaknesses.
}
